...
CREATE DATABASE IF NOT EXISTS `opsmonitor` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `opsmonitor`;
...
CREATE TABLE `SYSTEM_INFO` (
  ...
  `STATE` char(1) DEFAULT NULL,
  `REMARK` varchar(50) DEFAULT NULL,
  `DISK_PER` double(8,2) DEFAULT NULL,
