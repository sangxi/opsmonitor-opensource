...
function setHostRemark(id, hostRemark, groupName, tags) {
    $("#id").val(id);
    $("#remark").val(hostRemark == null ? "" : hostRemark);
    $("#groupName").val(groupName == null ? "" : groupName);
    $("#tags").val(tags == null ? "" : tags);
}
