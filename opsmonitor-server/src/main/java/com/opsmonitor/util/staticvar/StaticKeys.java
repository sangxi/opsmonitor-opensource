package com.opsmonitor.util.staticvar;
...
public class StaticKeys {
    ...
    //session中存储的验证码生成时间戳key（用于有效期校验）
    public static final String SESSION_CODE_TIME = "valcode_time";

    //验证码有效期（毫秒），默认5分钟
    public static final long CODE_EXPIRE_MS = 5 * 60 * 1000L;
