...
public class MailSet extends BaseEntity {
    ...
    public String getSendWebhook() {
        return sendWebhook;
    }

    public void setSendWebhook(String sendWebhook) {
    ...
    public String getWeixinWebhook() {
        return weixinWebhook;
    }

    public void setWeixinWebhook(String weixinWebhook) {
        this.weixinWebhook = weixinWebhook;
    }
}