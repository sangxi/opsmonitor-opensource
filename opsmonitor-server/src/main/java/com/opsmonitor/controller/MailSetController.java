...
import com.opsmonitor.service.MailSetService;
import com.opsmonitor.util.msg.WarnMailUtil;
import com.opsmonitor.util.msg.WarnWebhookUtil;
...
public class MailSetController {
    ...
    public String test(MailSet mailSet, Model model, HttpServletRequest request) {
        ...
        try {
            ...
            StaticKeys.mailSet = mailSet;
            result = WarnMailUtil.sendMail(mailSet.getToMail(), "OpsMonitor测试邮件发送", "OpsMonitor测试邮件发送");
        } catch (Exception e) {
