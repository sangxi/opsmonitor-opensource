...
public class OshiUtil {
     ...
     * @throws Exception
     */
    public static com.opsmonitor.entity.SystemInfo os(CentralProcessor processor, OperatingSystem os) throws Exception {
        com.opsmonitor.entity.SystemInfo systemInfo = new com.opsmonitor.entity.SystemInfo();
     ...
     * @return
     */
    public static SysLoadState getLoadState(com.opsmonitor.entity.SystemInfo systemInfo, CentralProcessor processor) throws Exception {
