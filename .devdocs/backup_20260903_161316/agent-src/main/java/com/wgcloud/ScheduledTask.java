...
public class ScheduledTask {
    ...
    public void appInfoListTask() {
        ...
        try {
            ...
            String resultJson = restUtil.post(commonConfig.getServerUrl() + "/opsmonitor/appInfo/agentList", paramsJson);
            if (resultJson != null) {
